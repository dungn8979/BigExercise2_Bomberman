package com.example.bomberman_starter_1.graphics;
...
public class Sprite {
	...
	public final int SIZE; // D34 final=16
	private int _x, _y; // D34 real coordinate pixels
	public int[] _pixels;
	protected int _realWidth;
	protected int _realHeight;
	private SpriteSheet _sheet;

	public static Sprite nan = new Sprite(DEFAULT_SIZE, 4, 1, SpriteSheet.tiles, 16, 16);
	/*
	|--------------------------------------------------------------------------
	| Board sprites
	|--------------------------------------------------------------------------
